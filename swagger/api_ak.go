...
func (a *AkApiService) AkAkIdGet(ctx context.Context, akId int64) (GetAkResponse, error) {
	var (
		...
		localVarReturnValue GetAkResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ak/{ak_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"ak_id"+"}", fmt.Sprintf("%v", akId), -1)
...
*/
func (a *AkApiService) AkAllGet(ctx context.Context) (InlineResponse20057, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ak/all"
...
func (a *AkApiService) AkPost(ctx context.Context, body Ak) (Response, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ak"
