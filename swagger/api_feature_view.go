...
*/
func (a *FeatureViewApiService) AddFeatureView(ctx context.Context, body FeatureView) (ModelApiResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/feature_views"
...
func (a *FeatureViewApiService) AppendFeatureViewFeatures(ctx context.Context, body FeatureView, featureViewId string) (ModelApiResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/{feature_view_id}/features"
	localVarPath = strings.Replace(localVarPath, "{"+"feature_view_id"+"}", fmt.Sprintf("%v", featureViewId), -1)
...
func (a *FeatureViewApiService) DeleteFeatureViewByID(ctx context.Context, featureViewId string) (ModelApiResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/{feature_view_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"feature_view_id"+"}", fmt.Sprintf("%v", featureViewId), -1)
...
func (a *FeatureViewApiService) GetFeatureViewOnlineFeatures(ctx context.Context, body OnlineFeaturesBody, featureViewId string) (InlineResponse20081, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/{feature_view_id}/online/features"
	localVarPath = strings.Replace(localVarPath, "{"+"feature_view_id"+"}", fmt.Sprintf("%v", featureViewId), -1)
...
func (a *FeatureViewApiService) GetFeatureViewOwners(ctx context.Context) (InlineResponse20082, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/owners"
...
*/
func (a *FeatureViewApiService) GetFeatureViewTags(ctx context.Context) (InlineResponse20083, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/tags"
...
func (a *FeatureViewApiService) ListFeatureViews(ctx context.Context, localVarOptionals *FeatureViewApiListFeatureViewsOpts) (ListFeatureViewsResponse, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *FeatureViewApiService) PublishFeatureViewTable(ctx context.Context, body PublishTableRequest, featureViewId string) (ModelApiResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/{feature_view_id}/publish_table"
	localVarPath = strings.Replace(localVarPath, "{"+"feature_view_id"+"}", fmt.Sprintf("%v", featureViewId), -1)
...
func (a *FeatureViewApiService) WriteFeatureViewTable(ctx context.Context, body WriteTableRequest, featureViewId string) (ModelApiResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/feature_views/{feature_view_id}/write_table"
	localVarPath = strings.Replace(localVarPath, "{"+"feature_view_id"+"}", fmt.Sprintf("%v", featureViewId), -1)
