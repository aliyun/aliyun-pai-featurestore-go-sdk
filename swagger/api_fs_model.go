...
func (a *FsModelApiService) AddFSModel(ctx context.Context, body Model) (ModelApiResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/models"
...
@return ModelApiResponse
*/
func (a *FsModelApiService) CreateTrainingSetTable(ctx context.Context, body ModelsTrainningSetTablesBody) (ModelApiResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/models/trainning_set_tables"
...
func (a *FsModelApiService) DeleteModelByID(ctx context.Context, modelId string) (ModelApiResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/models/{model_id}"
...
func (a *FsModelApiService) ExportTrainingSetTable(ctx context.Context, body TrainningSetTablesExportBody, modelId string) (InlineResponse20088, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/models/{model_id}/trainning_set_tables/export"
	localVarPath = strings.Replace(localVarPath, "{"+"model_id"+"}", fmt.Sprintf("%v", modelId), -1)
...
func (a *FsModelApiService) GetOnlineFeaturesByModelId(ctx context.Context, body OnlineFeaturesBody1, modelId string) (InlineResponse20081, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/models/{model_id}/online/features"
	localVarPath = strings.Replace(localVarPath, "{"+"model_id"+"}", fmt.Sprintf("%v", modelId), -1)
...
*/
func (a *FsModelApiService) PreveiwTrainingSetTable(ctx context.Context, body TrainningSetTablesPreviewBody) (InlineResponse20087, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/models/trainning_set_tables/preview"
