...
/*
DatasourceApiService Get all datasource
Get all datasource
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return InlineResponse20060
*/
func (a *DatasourceApiService) DatasourceAllGet(ctx context.Context) (InlineResponse20060, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/datasource/all"
...
func (a *DatasourceApiService) DatasourceDatasourceIdGet(ctx context.Context, datasourceId int64) (GetDatasourceResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/datasource/{datasource_id}"
...
/*
DatasourceApiService update datasource data
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param datasourceId ID of datasource to update
 * @param optional nil or *DatasourceApiDatasourceDatasourceIdPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Datasource) -  Datasource object that needs to be update
...
func (a *DatasourceApiService) DatasourcePost(ctx context.Context, body Datasource) (Response, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/datasource"
