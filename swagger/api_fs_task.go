...
/*
FsTaskApiService List Tasks
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param limit
 * @param optional nil or *FsTaskApiListTasksOpts - Optional Parameters:
     * @param "State" (optional.Int32) -
...
/*
FsTaskApiService List Tasks by subject
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param taskSubjectType
 * @param taskSubject
 * @param optional nil or *FsTaskApiListTasksBySubjectOpts - Optional Parameters:
...
func (a *FsTaskApiService) ListTasksBySubject(ctx context.Context, taskSubjectType string, taskSubject string, localVarOptionals *FsTaskApiListTasksBySubjectOpts) (InlineResponse20090, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/tasks/{task_subject_type}/{task_subject}"
	localVarPath = strings.Replace(localVarPath, "{"+"task_subject_type"+"}", fmt.Sprintf("%v", taskSubjectType), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"task_subject"+"}", fmt.Sprintf("%v", taskSubject), -1)
