...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.FsTaskApi = (*FsTaskApiService)(&c.common)
	c.SceneApi = (*SceneApiService)(&c.common)
	c.TableMetaApi = (*TableMetaApiService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	if c.cfg.Token != "" {
		localVarRequest.Header.Add("Authorization", c.cfg.Token)
	}
...
func (c *APIClient) decodeResponse(v interface{}, b []byte) (err error) {
