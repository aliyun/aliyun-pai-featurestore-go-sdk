...
*/
func (a *SceneApiService) AddScene(ctx context.Context, body Scene) (InlineResponse200, *http.Response, error) {
	var (
...
@return InlineResponse2001
*/
func (a *SceneApiService) ListAllScenes(ctx context.Context) (InlineResponse2001, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
